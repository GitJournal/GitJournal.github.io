(() => {
  ...
  var require_jquery = __commonJS((exports, module) => {
    ...
    (function(global, factory) {
      ...
      var version11 = "3.6.0", jQuery = function(selector, context) {
      ...
      jQuery.extend({
        expando: "jQuery" + (version11 + Math.random()).replace(/\D/g, ""),
        isReady: true,
        error: function(msg) {
          throw new Error(msg);
        },
      ...
      var Sizzle = function(window3) {
        var i, support2, Expr, getText, isXML, tokenize, compile, select, outermostContext, sortInput, hasDuplicate, setDocument, document3, docElem, documentIsHTML, rbuggyQSA, rbuggyMatches, matches, contains, expando = "sizzle" + 1 * new Date(), preferredDoc = window3.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), nonnativeSelectorCache = createCache(), sortOrder = function(a, b) {
          ...
          return 0;
        }, hasOwn2 = {}.hasOwnProperty, arr2 = [], pop = arr2.pop, pushNative = arr2.push, push3 = arr2.push, slice2 = arr2.slice, indexOf2 = function(list, elem) {
      ...
      function on(elem, types5, selector, data, fn, one) {
        var origFn, type;
        if (typeof types5 === "object") {
          if (typeof selector !== "string") {
            data = data || selector;
            selector = void 0;
          }
          for (type in types5) {
            on(elem, type, selector, data, types5[type], one);
          }
          return elem;
        }
        ...
        return elem.each(function() {
          jQuery.event.add(this, types5, fn, data, selector);
        });
      }
      jQuery.event = {
        global: {},
        add: function(elem, types5, handler, data, selector) {
          ...
          types5 = (types5 || "").match(rnothtmlwhite) || [""];
          t = types5.length;
          while (t--) {
            tmp = rtypenamespace.exec(types5[t]) || [];
            type = origType = tmp[1];
        ...
        remove: function(elem, types5, handler, selector, mappedTypes) {
          ...
          while (t--) {
            ...
            if (!type) {
              for (type in events) {
                jQuery.event.remove(elem, type + types5[t], handler, selector, true);
              }
              continue;
            }
            special = jQuery.event.special[type] || {};
      ...
      jQuery.fn.extend({
        on: function(types5, selector, data, fn) {
          return on(this, types5, selector, data, fn);
        },
        one: function(types5, selector, data, fn) {
          return on(this, types5, selector, data, fn, 1);
        },
        off: function(types5, selector, fn) {
          var handleObj, type;
          if (types5 && types5.preventDefault && types5.handleObj) {
            handleObj = types5.handleObj;
            jQuery(types5.delegateTarget).off(handleObj.namespace ? handleObj.origType + "." + handleObj.namespace : handleObj.origType, handleObj.selector, handleObj.handler);
            return this;
          }
          if (typeof types5 === "object") {
            for (type in types5) {
              this.off(type, selector, types5[type]);
            }
            return this;
          }
          ...
          return this.each(function() {
            jQuery.event.remove(this, types5, fn, selector);
          });
        }
      });
      ...
      jQuery.fx.tick = function() {
        var timer3, i = 0, timers = jQuery.timers;
        fxNow = Date.now();
        for (; i < timers.length; i++) {
          timer3 = timers[i];
          if (!timer3() && timers[i] === timer3) {
            timers.splice(i--, 1);
          }
        }
        if (!timers.length) {
      ...
      jQuery.fx.timer = function(timer3) {
        jQuery.timers.push(timer3);
        jQuery.fx.start();
      };
      ...
      jQuery.fn.extend({
        bind: function(types5, data, fn) {
          return this.on(types5, null, data, fn);
        },
        unbind: function(types5, fn) {
          return this.off(types5, null, fn);
        },
        delegate: function(selector, types5, data, fn) {
          return this.on(types5, selector, data, fn);
        },
        undelegate: function(selector, types5, fn) {
          return arguments.length === 1 ? this.off(selector, "**") : this.off(types5, selector || "**", fn);
        },
  ...
  const version10 = "1.24.0";

  // node_modules/@supabase/supabase-js/dist/module/lib/constants.js
  const DEFAULT_HEADERS5 = {"X-Client-Info": `supabase-js/${version10}`};
  ...
  const cross_fetch = __toModule(require_browser_ponyfill());
  ...
  function _handleRequest(method, url, options, body) {
    return __awaiter3(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) => {
        cross_fetch.default(url, _getRequestParams(method, options, body)).then((result) => {
          if (!result.ok)
            throw result;
  ...
  const DEFAULT_HEADERS = {"X-Client-Info": `gotrue-js/${version2}`};
  const EXPIRY_MARGIN = 60 * 1e3;
  ...
  function setCookies(req, res, cookies2) {
    const strCookies = cookies2.map((c) => serializeCookie(c, isSecureEnvironment(req)));
  ...
  class SupabaseAuthClient2 extends GoTrueClient {
    constructor(options) {
      super(options);
    }
  }
  ...
  const cross_fetch2 = __toModule(require_browser_ponyfill());
  ...
  class PostgrestBuilder {
    ...
    then(onfulfilled, onrejected) {
      ...
      let res = cross_fetch2.default(this.url.toString(), {
        method: this.method,
        headers: this.headers,
  ...
  class PostgrestTransformBuilder2 extends PostgrestBuilder {
    select(columns = "*") {
      let quoted = false;
    ...
    maybeSingle() {
      this.headers["Accept"] = "application/vnd.pgrst.object+json";
      const _this = new PostgrestTransformBuilder2(this);
  ...
  class PostgrestFilterBuilder2 extends PostgrestTransformBuilder2 {
    constructor() {
      super(...arguments);
  ...
  class PostgrestQueryBuilder2 extends PostgrestBuilder {
    ...
    select(columns = "*", {head = false, count = null} = {}) {
      ...
      return new PostgrestFilterBuilder2(this);
    }
  ...
  class PostgrestRpcBuilder2 extends PostgrestBuilder {
    constructor(url, {headers = {}, schema} = {}) {
      super({});
      this.url = new URL(url);
      this.headers = Object.assign({}, headers);
  ...
  const version4 = "0.34.0";

  // node_modules/@supabase/postgrest-js/dist/module/lib/constants.js
  const DEFAULT_HEADERS2 = {"X-Client-Info": `postgrest-js/${version4}`};
  ...
  class PostgrestClient {
    ...
    from(table) {
      ...
      return new PostgrestQueryBuilder2(url, {headers: this.headers, schema: this.schema});
    }
    rpc(fn, params, {head = false, count = null} = {}) {
      const url = `${this.url}/rpc/${fn}`;
      return new PostgrestRpcBuilder2(url, {
        headers: this.headers,
        schema: this.schema
  ...
  const version6 = "1.1.3";

  // node_modules/@supabase/realtime-js/dist/module/lib/constants.js
  const DEFAULT_HEADERS3 = {"X-Client-Info": `realtime-js/${version6}`};
  const VSN = "1.0.0";
  ...
  const websocket = __toModule(require_browser());
  ...
  class RealtimeClient {
    ...
    channel(topic, chanParams = {}) {
      let chan = new RealtimeSubscription2(topic, chanParams, this);
  ...
  class SupabaseQueryBuilder2 extends PostgrestQueryBuilder2 {
    constructor(url, {headers = {}, schema, realtime, table}) {
      super(url, {headers, schema});
      this._subscription = new SupabaseRealtimeClient2(realtime, headers, schema, table);
  ...
  const cross_fetch4 = __toModule(require_browser_ponyfill());
  ...
  const _getErrorMessage2 = (err) => err.msg || err.message || err.error_description || err.error || JSON.stringify(err);
  const handleError2 = (error, reject) => {
    if (typeof error.json !== "function") {
      return reject(error);
    }
    error.json().then((err) => {
  ...
  const _getRequestParams2 = (method, options, parameters, body) => {
    const params = {method, headers: (options === null || options === void 0 ? void 0 : options.headers) || {}};
    if (method === "GET") {
      return params;
    }
  ...
  function _handleRequest2(method, url, options, parameters, body) {
    return __awaiter8(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) => {
        cross_fetch4.default(url, _getRequestParams2(method, options, parameters, body)).then((result) => {
          if (!result.ok)
            throw result;
          if (options === null || options === void 0 ? void 0 : options.noResolveJson)
  ...
  function put2(url, body, options, parameters) {
    return __awaiter8(this, void 0, void 0, function* () {
      return _handleRequest2("PUT", url, options, parameters, body);
    });
  }
  function remove2(url, body, options, parameters) {
    return __awaiter8(this, void 0, void 0, function* () {
  ...
  const version8 = "0.0.0";

  // node_modules/@supabase/storage-js/dist/module/lib/constants.js
  const DEFAULT_HEADERS4 = {"X-Client-Info": `storage-js/${version8}`};
  ...
  class StorageBucketApi {
    constructor(url, headers = {}) {
      this.url = url;
      this.headers = Object.assign(Object.assign({}, DEFAULT_HEADERS4), headers);
    }
    listBuckets() {
    ...
    createBucket(id, options = {public: false}) {
      return __awaiter6(this, void 0, void 0, function* () {
        try {
          const data = yield post2(`${this.url}/bucket`, {id, name: id, public: options.public}, {headers: this.headers});
    ...
    updateBucket(id, options) {
      return __awaiter6(this, void 0, void 0, function* () {
        try {
          const data = yield put2(`${this.url}/bucket/${id}`, {id, name: id, public: options.public}, {headers: this.headers});
          return {data, error: null};
        } catch (error) {
          return {data: null, error};
        }
  ...
  const cross_fetch3 = __toModule(require_browser_ponyfill());
    ...
    uploadOrUpdate(method, path, fileBody, fileOptions) {
      return __awaiter7(this, void 0, void 0, function* () {
        try {
          ...
          const res = yield cross_fetch3.default(`${this.url}/object/${_path}`, {
            method,
            body,
            headers
          });
  ...
  class SupabaseClient {
    ...
    from(table) {
      ...
      return new SupabaseQueryBuilder2(url, {
    ...
    _initSupabaseAuthClient({autoRefreshToken, persistSession, detectSessionInUrl, localStorage, headers}) {
      ...
      return new SupabaseAuthClient2({
        url: this.authUrl,
    ...
    _getAuthHeaders() {
      var _a, _b;
      const headers = DEFAULT_HEADERS5;
  ...
  async function login() {
    ...
    const sup = createClient("https://kokulrmhlfxdwuvcmblj.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzMTM3NDY4OSwiZXhwIjoxOTQ2OTUwNjg5fQ.LvaFM84Q00RKkRTyIDjzZAnkzba30bnRhQZQldj1AfU");
  ...
  function showError(message) {
    jquery.default("#form-error").removeClass("hidden");
    jquery.default("#form-error-text").text(message);
  }
