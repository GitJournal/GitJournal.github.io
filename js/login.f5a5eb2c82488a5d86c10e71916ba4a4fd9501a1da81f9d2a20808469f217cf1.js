(() => {
  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global, factory) {
        ...
        var version6 = "3.6.0", jQuery = function(selector, context) {
        ...
        jQuery.extend({
          expando: "jQuery" + (version6 + Math.random()).replace(/\D/g, ""),
          isReady: true,
          error: function(msg) {
            throw new Error(msg);
          },
  ...
  var PostgrestBuilder = class {
    ...
    then(onfulfilled, onrejected) {
      ...
      let res = (0, import_cross_fetch2.default)(this.url.toString(), {
        method: this.method,
        headers: this.headers,
  ...
  function showError(message) {
    (0, import_jquery.default)("#form-error").removeClass("hidden");
    (0, import_jquery.default)("#form-error-text").text(message);
  }
